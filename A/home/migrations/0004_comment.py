...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0003_alter_post_user_options_alter_post_user_created_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pcomment', to='home.post_user')),
